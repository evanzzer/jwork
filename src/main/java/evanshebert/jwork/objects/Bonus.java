...
public class Bonus {
     ...
     *
     * @param id           Bonus ID
     * @param referralCode Referral Code for Bonus Identifier
     * @param extraFee     Extra Fee applied for the specified bonus
     * @param minTotalFee  Minimum Fee required for the bonus to apply
