...
public class Jobseeker {
    ...
    /**
     * Declare a jobseeker with a specified date
     *
    ...
    /**
     * Declare a jobseeker with a specified date specifying year, month, day of Month
     *
     * @param id         Jobseeker's ID
     * @param name       Jobseeker's name
     * @param email      Jobseeker's email
     * @param password   Jobseeker's password
     * @param year       Jobseeker's join year
     * @param month      Jobseeker's join month
     * @param dayOfMonth Jobseeker's join day
     */
    ...
    /**
     * Declare a jobseeker that has just joined
     *
     * @param id       Jobseeker's ID
     * @param name     Jobseeker's name
     * @param email    Jobseeker's email
